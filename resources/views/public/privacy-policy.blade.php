...
<head>
    ...
    <title>{{ app()->getLocale() == 'ar' ? $policy->title_ar : $policy->title }} - مهرجان صحار Sohar Festival</title>
...
<body>
    ...
    <div class="content-wrapper">
        ...
        <div class="content-card">
            {!! app()->getLocale() == 'ar' ? $policy->content_ar : $policy->content !!}
        </div>

        <div class="footer-links">
            <a href="{{ route('public.terms-and-conditions', ['lang' => app()->getLocale()]) }}">
